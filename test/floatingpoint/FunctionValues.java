...
public class FunctionValues {
	...
	public static void functionValues_v3(double start, double stop, double increment)  {
		double x = start - 0.1;
		for (int i = 1; i <= 5; i += 1) {
			x += 0.1;
			System.out.println("x=" + x);
	...
	public static void main(String[] args) {
		...
		System.out.println("v3(0.1, 0.5, 0.1)");
		functionValues_v3(0.1, 0.5, 0.1);
		System.out.println("v3(1.1, 1.5, 0.1)");
		functionValues_v3(1.1, 1.5, 0.1);
